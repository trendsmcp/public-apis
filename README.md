...
| [TrendsMCP](https://trendsmcp.ai) | Real-time search trend data from Google, YouTube, TikTok, Reddit, Spotify, Steam, npm, App Store, and more via REST API or MCP | `apiKey` | Yes | Yes |
